...
```{r veglist, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r vegmap, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r veg_merge, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r plot-1, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r plot-2, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r get-chm, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r plot-chm, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
