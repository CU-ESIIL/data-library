...
```{r convert to df, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r aggregate data for plots, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot Borrelia burgdorferi by taxonID and site, echo=FALSE, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot tick populations, echo=FALSE, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
