---
title: "Eco-Florida food network"
format: gfm
---

This dataset from the Network Repository, titled "eco-florida," represents a food web of the Everglades in South Florida. The nodes in this network are species or groups of species, and the directed edges represent predator-prey relationships. The network contains 128 nodes and 2,102 directed edges.

```{r, cache=TRUE, eval=FALSE}
# List of packages to install
package_list <- c("igraph", "tidygraph", "ggraph", "httr", "zip")
