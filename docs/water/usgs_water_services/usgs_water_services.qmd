...
The United States Geological Survey (USGS) provides APIs for accessing real-time and historical water data, such as streamflow, groundwater levels, and water quality measurements. In this example, we will download the real-time streamflow data for a specific site and create a plot of the data.
...
# Retrieve daily streamflow data for the specified site and date range
data = hf.NWIS(site, parameterCd=parameterCd, start_date=startDate, end_date=endDate).get_data()
